...
from ..pixel_decoder.fpn import BasePixelDecoder, TransformerEncoderPixelDecoder


@SEM_SEG_HEADS_REGISTRY.register()
class EnhancerMaskFormerHead(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        # if cfg.MODEL.SEM_SEG_HEAD.ENHANCER_DECODER_NAME == "MSDeformAttnPixelDecoder":
        #     enhancer = MSDeformAttnPixelDecoder(
        #         input_shape = {
        #             k: v for k, v in input_shape.items() if k in cfg.MODEL.SEM_SEG_HEAD.IN_FEATURES
        #         },
        #         conv_dim = cfg.MODEL.SEM_SEG_HEAD.CONVS_DIM,
        #         mask_dim = cfg.MODEL.SEM_SEG_HEAD.ENHANCER_OUTPUT_DIM, # CHANGE TO ENHANCER_OUTPUT_DIM
        ...
        #     )
        # elif cfg.MODEL.SEM_SEG_HEAD.ENHANCER_DECODER_NAME == "BasePixelDecoder":
        #     enhancer = BasePixelDecoder(
        #         input_shape = {
        #             k: v for k, v in input_shape.items() if k in cfg.MODEL.SEM_SEG_HEAD.IN_FEATURES
        #         },
        #         conv_dim = cfg.MODEL.SEM_SEG_HEAD.CONVS_DIM,
        ...
        #         norm = cfg.MODEL.SEM_SEG_HEAD.NORM,
        #     )
        # elif cfg.MODEL.SEM_SEG_HEAD.ENHANCER_DECODER_NAME == "TransformerEncoderPixelDecoder":
        #     enhancer = TransformerEncoderPixelDecoder(
        #         input_shape = {
        #             k: v for k, v in input_shape.items() if k in cfg.MODEL.SEM_SEG_HEAD.IN_FEATURES
        #         },
        #         conv_dim = cfg.MODEL.SEM_SEG_HEAD.CONVS_DIM,
        ...
        #         transformer_enc_layers = cfg.MODEL.SEM_SEG_HEAD.TRANSFORMER_ENC_LAYERS,
        #         transformer_pre_norm = cfg.MODEL.MASK_FORMER.PRE_NORM,
        #     )
        enhancer = MSDeformAttnPixelDecoder(
            input_shape = {
                k: v for k, v in input_shape.items() if k in cfg.MODEL.SEM_SEG_HEAD.IN_FEATURES
    ...
    def layers(self, features, mask=None):
        enhanced_mask, tmp1, tmp2, tmp = self.enhancer.forward_features(features)
