...
class EnhancerSimpleMaskFormerHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.enhancer = nn.Conv2d(256, 3, kernel_size=1, stride=1, padding=0)
        weight_init.c2_xavier_fill(self.enhancer)
    ...
    def layers(self, features, mask=None):
        ...
        enhanced_mask = self.enhancer(clip_mask_features)
