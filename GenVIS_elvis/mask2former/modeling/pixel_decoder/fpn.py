    ...
    def forward_features(self, features):
        ...
        for idx, f in enumerate(self.in_features[::-1]):
            ...
            if num_cur_levels < self.maskformer_num_feature_levels:
                ...
                num_cur_levels += 1
        # return self.mask_features(y), self.clip_mask_features(y), None, multi_scale_features
        return self.mask_features(y), y, None, multi_scale_features
    ...
    def forward_features(self, features):
        ...
        for idx, f in enumerate(self.in_features[::-1]):
            ...
            if num_cur_levels < self.maskformer_num_feature_levels:
                multi_scale_features.append(y)
                num_cur_levels += 1
        return self.mask_features(y), y, transformer_encoder_features, multi_scale_features
