...
from vita import (
    YTVISDatasetMapper,
    SynthLowlightYTVISDatasetMapper,
    CocoClipDatasetMapper,
    SynthLowlightCocoClipDatasetMapper,
    YTVISEvaluator,
    ...
    def build_train_loader(cls, cfg):
        ...
        for d_i, dataset_name in enumerate(cfg.DATASETS.TRAIN):
            if dataset_name.startswith('coco'):
                ...
                # For training, use synthlowlight mapper
                mappers.append(
                    SynthLowlightYTVISDatasetMapper(cfg,
                    is_train=True,
...
def add_synthesis_pipeline_config(cfg):
    ...
    cfg.INPUT.SYNTHESIS.PARAM_ROOT = "./noise_params"
    cfg.INPUT.SYNTHESIS.RETURN_DEGRADATION_PARAMS = False
    cfg.MODEL.SEM_SEG_HEAD.ENHANCER_OUTPUT_DIM = 3
    cfg.MODEL.SEM_SEG_HEAD.ENHANCER_DECODER_NAME = "MSDeformAttnPixelDecoder"
