...
class Trainer(DefaultTrainer):
    ...
    def test(cls, cfg, model, evaluators=None):
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TEST):
            ...
            print("printing results:", results_i)
            print_csv_format(results_i)
...
def add_synthesis_pipeline_config(cfg):
    # Add custom config options
    cfg.INPUT.SYNTHESIS = CN()
    cfg.INPUT.SYNTHESIS.DEGRADATION_MODEL = "proposed"
    cfg.INPUT.SYNTHESIS.PARAM_ROOT = "./synth_noise_params"
    cfg.INPUT.SYNTHESIS.RETURN_DEGRADATION_PARAMS = False
    cfg.MODEL.SEM_SEG_HEAD.ENHANCER_OUTPUT_DIM = 3
...
def setup(args):
    ...
    add_synthesis_pipeline_config(cfg)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lmots-frames",
        type=str,
        default="/home/b5ba/fn20123.b5ba/scratch/datasets/LMOT/LMOT_segm_720_split/all_frames/valid_all_frames/JPEGImages",
        help="path to LMOTS dataset frames")
    parser.add_argument(
        "--lmots-annots",
        type=str,
        default="/home/b5ba/fn20123.b5ba/scratch/datasets/LMOT/LMOT_segm_720_split/annotations/valid.json",
        help="path to LMOTS json file")
