...
class GenvisHungarianMatcher(nn.Module):
    ...
    @torch.no_grad()
    def memory_efficient_forward(self, outputs, targets, prev_clip_indices=None):
    ...
    def forward(self, outputs, targets, prev_clip_indices=None):
        ...
        """
        return self.memory_efficient_forward(outputs, targets, prev_clip_indices)
